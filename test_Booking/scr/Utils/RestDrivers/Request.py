...
class Request:
    ...
    def execute(operation, url, payload=None, token=None):
        ...
        :param operation: The HTTP operation to perform.
        :param url: The URL for the request.
        :param payload: The JSON payload for the request (optional).
        ...
        try:
            ...
            if "text/plain" in content_type:
                ...
                return response.status_code, response.content, None  # Fallback for other content types
    ...
    def construct_param_filters(filters):
        ...
        :param filters: A dictionary of filters to be applied to the request.
        :return: A string of URL-encoded query parameters.
        """
        query_params = []
