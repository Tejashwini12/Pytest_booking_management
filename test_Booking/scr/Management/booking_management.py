...
from test_Booking.scr.Manager.bookingmanager import BookingManager
...
class BookingManagement:
    ...
    def ping_data(self, base_url: str, exp_status=Response.StatusCode.HTTP_OK):
    ...
    def update_booking_data(self, base_url: str, booking_id: int, token: str = None, exp_status=Response.StatusCode.HTTP_OK):
        ...
        booking_manager = BookingManager(self.session)
        return booking_manager.update_booking(base_url, booking_id, token=actual_token)

    def partial_update_booking_data(self, base_url: str, booking_id: int, token: str = None, exp_status=Response.StatusCode.HTTP_OK):
        ...
        booking_manager = BookingManager(self.session)
        return booking_manager.partial_update_booking(base_url, booking_id, token=actual_token)

    def get_booking_ids_data(self, base_url: str, token: str = None, exp_status=Response.StatusCode.HTTP_OK):
    ...
    def get_booking_by_id_data(self, base_url: str, booking_id: int, token: str = None, exp_status=Response.StatusCode.HTTP_OK):
    ...
    def filter(self, base_url: str, filters: dict, exp_status=Response.StatusCode.HTTP_OK):
